...
technical_background:
  [
    "Team Lead - Software Alliance,
    "Development Lead - Solution Hut",
    "Web Developer - NovaLogic Solutions",
  ]
  
currently_learning: ["Docker, Kubernetes"]
2023 Goals: ["Create 10+ Projects and learn at least 1 new Technology."]
hobbies: ["Gaming", "Movies", "Formula1"]
```
...
![Snake animation](https://github.com/burhanahmed92/burhanahmed92/blob/output/github-contribution-grid-snake.svg)
